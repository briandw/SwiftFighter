...
SWIFT_CLASS("_TtC7PlotKit8DataView")
...
SWIFT_CLASS("_TtC7PlotKit11HeatMapView")
@interface HeatMapView : DataView

/// A function that maps from an x, y value pair to a z value
@property (nonatomic, copy) double (^ _Nullable valueFunction)(double, double);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValueFunction:(double (^ _Nonnull)(double, double))valueFunction;
...
SWIFT_CLASS("_TtC7PlotKit12PointSetView")
@interface PointSetView : DataView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(CGRect)rect;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
